Pod::Spec.new do |s|
  ...
  s.version      = "2.0.11"      #版本号，与tag值一致
  s.summary      = "a CGXPickerView demo标签封装"  #简介
  s.description  = "a CGXPickerView标签封装"  #描述
  s.homepage     = "https://github.com/hanshantao/CGXPickerViewDemo"      #项目主页，不是git地址
  s.license      = { :type => "MIT", :file => "LICENSE" }   #开源协议
  s.author             = { "974794055" => "974794055@qq.com" }  #作者
  s.platform     = :ios, "7.0"                  #支持的平台和版本号
  s.source       = { :git => "https://github.com/hanshantao/CGXPickerViewDemo.git", :tag =>        s.version }         #存储库的git地址，以及tag值
